...
export default function Footer() {
  ...
  return (
    <footer className="mt-auto shrink-0 border-t border-border pb-10 pt-10 text-muted-foreground">
      <div
        className={cn(
          shellContentClass,
      ...
      >
        ...
        <p className="m-0 text-xs font-semibold tracking-wider uppercase">
